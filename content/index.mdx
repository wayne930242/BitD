...
<img style="width:100%;" src="/BitD/BitD.png" />

暗夜冷鋒（Blades in the Dark）的[系統參照文件（SRD）](https://github.com/amazingrando/BitD-content)由 Evil Hat 以[創用 CC-BY](http://creativecommons.org/licenses/by/3.0/)授權釋出。
